...
"}"));
        ...
        numPadWidget = new QWidget(DepositWindow);
        numPadWidget->setObjectName(QStringLiteral("numPadWidget"));
        horizontalLayout_6 = new QHBoxLayout(numPadWidget);
        horizontalLayout_6->setObjectName(QStringLiteral("horizontalLayout_6"));
        numPadWidget1 = new QWidget(numPadWidget);
        ...
        numPadDisplayWidget = new QWidget(numPadWidget);
        ...
        verticalLayout->addWidget(numPadWidget);
