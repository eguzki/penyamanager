...
public:
    ...
    QGroupBox *numPadGroupBox;
    QHBoxLayout *horizontalLayout_6;
    QWidget *numPadWidget;
    ...
    void setupUi(QWidget *DepositWindow)
    {
        ...
        numPadGroupBox = new QGroupBox(DepositWindow);
        numPadGroupBox->setObjectName(QStringLiteral("numPadGroupBox"));
        horizontalLayout_6 = new QHBoxLayout(numPadGroupBox);
        horizontalLayout_6->setObjectName(QStringLiteral("horizontalLayout_6"));
        numPadWidget = new QWidget(numPadGroupBox);
        numPadWidget->setObjectName(QStringLiteral("numPadWidget"));
        numPadWidget->setMinimumSize(QSize(366, 0));
        numPadWidget->setMaximumSize(QSize(366, 16777215));
        gridLayout = new QGridLayout(numPadWidget);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        pushButton_01 = new QPushButton(numPadWidget);
        ...
        pushButton_05 = new QPushButton(numPadWidget);
        ...
        pushButton_07 = new QPushButton(numPadWidget);
        ...
        pushButton_09 = new QPushButton(numPadWidget);
        ...
        pushButton_04 = new QPushButton(numPadWidget);
        ...
        pushButton_02 = new QPushButton(numPadWidget);
        ...
        pushButton_03 = new QPushButton(numPadWidget);
        ...
        pushButton_06 = new QPushButton(numPadWidget);
        ...
        pushButton_08 = new QPushButton(numPadWidget);
        ...
        pushButton_coma = new QPushButton(numPadWidget);
        ...
        pushButton_00 = new QPushButton(numPadWidget);
        ...
        pushButton_C = new QPushButton(numPadWidget);
        ...
        horizontalLayout_6->addWidget(numPadWidget);

        numPadDisplayWidget = new QWidget(numPadGroupBox);
        ...
        verticalLayout->addWidget(numPadGroupBox);

        newBalanceGroupBox = new QGroupBox(DepositWindow);
        newBalanceGroupBox->setObjectName(QStringLiteral("newBalanceGroupBox"));
        horizontalLayout_7 = new QHBoxLayout(newBalanceGroupBox);
        horizontalLayout_7->setObjectName(QStringLiteral("horizontalLayout_7"));
        newBalanceLabel = new QLabel(newBalanceGroupBox);
        newBalanceLabel->setObjectName(QStringLiteral("newBalanceLabel"));

        horizontalLayout_7->addWidget(newBalanceLabel);


        verticalLayout->addWidget(newBalanceGroupBox);
    ...
    void retranslateUi(QWidget *DepositWindow)
    {
        ...
        numPadGroupBox->setTitle(QApplication::translate("DepositWindow", "Deposit", 0));
        ...
        newBalanceGroupBox->setTitle(QApplication::translate("DepositWindow", "New Balance", 0));
