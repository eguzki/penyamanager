...
"    \n"
"    selection-color: rgb(117,117,117);\n"
...
"        background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop: 0 rg"
                        "b(239,83,80), stop: 0.5 rgb(239,83,80), stop:1 rgb(239,83,80));\n"
"        min-height: 0px;\n"
"}\n"
...
"}"));
        ...
        invoiceInfoWidget->setMaximumSize(QSize(450, 16777215));
        ...
        totalWidget->setMinimumSize(QSize(0, 50));
        totalWidget->setMaximumSize(QSize(16777215, 50));
